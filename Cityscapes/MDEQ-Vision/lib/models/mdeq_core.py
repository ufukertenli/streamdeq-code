...
class MDEQNet(nn.Module):
    ...
    def _forward(self, x_, train_step=-1, compute_jac_loss=True, spectral_radius_mode=False, writer=None, **kwargs):
        """
        ...
        deq_mode = ((train_step < 0) or (train_step >= self.pretrain_steps)) and deq_
